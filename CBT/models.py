...
class tblcbtexams(models.Model):
    ...
    def __unicode__(self):
        return '%s %s %s'%(self.exam_type,self.status)
        #ession,self.term)
...
class tbloptions(models.Model):
	...
	a = models.CharField('Option A', max_length=3500)
	b = models.CharField('Option B', max_length=3500)
	c = models.CharField('Option C', max_length=3500)
	d = models.CharField('Option D', max_length=3500)
	e = models.CharField('Option E', max_length=3500)
...
class tbltheory(models.Model):
	...
	instruction_to = models.CharField('From', max_length=975)
	instruction_from = models.CharField('From', max_length=975)
	image = models.ImageField('Image', upload_to='studentpix', null=True,blank=True,default='studentpix/user.png')
...
class tblcbtsubject(models.Model):
    ...
    def __unicode__(self):
    	...
    	return u' subject : %s , term : %s ' % (self.subject,self.term)
