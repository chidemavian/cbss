...
from bfc.bill.forms import *
from bfc.bill.models import *
from bfc.student.models import *
# from bfc.ruffwal.rsetup.models import *
#from bfc.ruffwal.stock.models import *
from bfc.sysadmin.forms import calendar_form
    ...
    if  "userid" in request.session:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                try:
                    from bfc.ruffwal.rsetup.models import tblaccount
