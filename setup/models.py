...
subject_category = (('PRY', 'PRY'),('JS', 'JS'),('Science', 'Science'), ('Commercial', 'Commercial'),('Art','Art'),('Remidials','Remidials'))
...
class Subject(models.Model):
    ...
    klass = models.CharField('Subject Class', default='SS', max_length=75)
