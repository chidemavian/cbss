...
subject_category2111 = (('-----', '-----'), ('Compulsory', 'Compulsory'), ('Optional', 'Optional'))

subject_category44 = (('-----', '-----'),('PRY', 'PRY'),('JS', 'JS'),('Science', 'Science'), ('Commercial', 'Commercial'),('Art','Art'))
...
class susesyform(forms.Form):
    group = forms.ChoiceField(label = 'Group', choices = subject_category44)
    category = forms.ChoiceField(label ='Category', choices = subject_category2111)
